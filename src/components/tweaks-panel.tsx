...
type TweakValues = Record<string, string | number | boolean | null | undefined>;

type SetTweak<T extends TweakValues> = (
...
const __TWEAKS_STYLE = `
  ...
  .twk-seg button,
  .twk-seg label{appearance:none;position:relative;z-index:1;flex:1;border:0;
    background:transparent;color:inherit;font:inherit;font-weight:500;min-height:22px;
    border-radius:6px;cursor:default;padding:4px 6px;line-height:1.2;
    overflow-wrap:anywhere;display:flex;align-items:center;justify-content:center}
...
export function TweaksPanel({ title = "Tweaks", children }: TweaksPanelProps) {
  ...
  return (
    <>
      ...
      >
        {/* biome-ignore lint/a11y/useSemanticElements: drag handle is a non-form control surface */}
        <div
          className="twk-hd"
          role="button"
          tabIndex={0}
