...
const steps = [
	{
		subTitle: "Install",
		title: "Add one line of script. Haya begins watching.",
		description:
			"Works with any stack: React, Vue, plain HTML. No configuration. No instrumentation. The agents start their communication loop the moment the script is live.",
		illustration: StepArtConnect,
	},
	{
		subTitle: "Observe",
		title: "Haya's agents run silently across every session.",
		description:
			"The observation agent captures behavioral signals in real time. The analysis agent decodes patterns across your entire user base building behavioral personas from what it sees, not what users say.",
		illustration: StepArtScan,
	},
	{
		subTitle: "Anticipate",
		title: "Your friction forecast arrives. Before users feel it.",
		description:
			"Haya surfaces your behavioral persona panel, ranks your friction points by revenue impact, and delivers specific fix recommendations with predicted conversion deltas. Ship with certainty, not gut feel.",
			...
			<div className="container gsap-reveal">
				<div className="section-head">
					...
					<h2 className="font-inter mb-4 text-balance">
						Three steps, <em>One behavioral truth.</em>
					</h2>
				</div>
				<div className="steps">
